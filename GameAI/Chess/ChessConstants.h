...
const unsigned int kPieceWorthPawn = 1;
const unsigned int kPieceWorthRook = 5;
const unsigned int kPieceWorthKnight = 3;
const unsigned int kPieceWorthBishop = 3;
const unsigned int kPieceWorthKing = 10000;
const unsigned int kPieceWorthQueen = 9;

const int kMaterialWeight = 1;
const int kCenterControlWeight = 1;
const int kKingSafety = 2;
const int kBishopCoverage = 1;
const int kQueenCoverage = 1;
const int kKnightCenterControlWeight = 1;
